...
AnimatedGraphicsComponent* GraphicsComponentFactory::BuildBunny(float width,  float height)
{
	...
	{
		Texture2D *idleTexture = GraphicsManager::Instance()->GetTexture(@"Bun_Idle");
	...
	{
		Texture2D *spriteTexture = GraphicsManager::Instance()->GetTexture(@"Bun_Walk");
	...
	{
		Texture2D *spriteTexture = GraphicsManager::Instance()->GetTexture(@"Bun_WalkFrontLeft");
		SpriteAnimation *spriteAnimation = new SpriteAnimation();
		spriteAnimation->mTileWidth = 8;
		spriteAnimation->mTileHeight = 4;
	...
	{
		Texture2D *spriteTexture = GraphicsManager::Instance()->GetTexture(@"Bun_WalkL");
		SpriteAnimation *spriteAnimation = new SpriteAnimation();
		spriteAnimation->mTileWidth = 8;
		spriteAnimation->mTileHeight = 4;
		spriteAnimation->mTileCount = 30;
	...
	{
		Texture2D *spriteTexture =  GraphicsManager::Instance()->GetTexture(@"Bun_WalkBackLeft");
		SpriteAnimation *spriteAnimation = new SpriteAnimation();
		spriteAnimation->mTileWidth = 8;
		spriteAnimation->mTileHeight = 4;
		spriteAnimation->mTileCount = 30;
	...
	{
		Texture2D *spriteTexture = GraphicsManager::Instance()->GetTexture(@"Bun_WalkBack");
		SpriteAnimation *spriteAnimation = new SpriteAnimation();
		spriteAnimation->mTileWidth = 8;
		spriteAnimation->mTileHeight = 4;
		spriteAnimation->mTileCount = 30;
	...
	{
		Texture2D *spriteTexture = GraphicsManager::Instance()->GetTexture(@"Bun_Blowupspin");
		SpriteAnimation *spriteAnimation = new SpriteAnimation();
		spriteAnimation->mTileWidth = 8;
		spriteAnimation->mTileHeight = 4;
		spriteAnimation->mTileCount = 30;
	...
	{
		Texture2D *spriteTexture = GraphicsManager::Instance()->GetTexture(@"Bun_JumpDownHole" );
	...
	{
		Texture2D *texture = GraphicsManager::Instance()->GetTexture(@"Bun_Eat_Carrot");
	...
	{
		Texture2D *texture = GraphicsManager::Instance()->GetTexture(@"Bun_Dance");
	...
	{
		Texture2D *texture = GraphicsManager::Instance()->GetTexture(@"Bun_Taunt");
		SpriteAnimation *anim = new SpriteAnimation();
		anim->mTileWidth = 16;
		anim->mTileHeight = 8;
		anim->mTileCount = 91;
	...
	{
		Texture2D *texture = GraphicsManager::Instance()->GetTexture(@"Bun_Burn");
		SpriteAnimation *anim = new SpriteAnimation();
		anim->mTileWidth = 8;
		anim->mTileHeight = 8;
		anim->mTileCount = 45;
	...
	{
		Texture2D *texture = GraphicsManager::Instance()->GetTexture(@"Bun_Electrocude");
		SpriteAnimation *anim = new SpriteAnimation();
		anim->mTileWidth = 8;
		anim->mTileHeight = 8;
		anim->mTileCount = 61;
